...
export default function ContactFormProduct({ productTitle }: { productTitle: string }): JSX.Element {
  ...
  const handleOnSubmit = (event: React.FormEvent): void => {
    ...
    fieldsCopy.message = `Produkt: ${productTitle}. Melding: ${fieldsCopy.message}`
