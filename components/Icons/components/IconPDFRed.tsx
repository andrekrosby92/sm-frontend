...
export default function IconPDFRed({ className }: { className?: string }): JSX.Element {
  return (
    <svg className={`fill-current ${className}`} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      <path d="M40,45H8V3h22l10,10V45z" fill="#ff5722" />
      <path d="M38.5,14H29V4.5L38.5,14z" fill="#fbe9e7" />
      <path
